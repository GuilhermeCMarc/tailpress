<article id="post-<?php echo get_the_ID() ?>" class="">
    ...
    <a href="<?php echo get_the_permalink() ?>">
        <img class="rounded-lg object-cover lg:h-48 w-full" src="<?php echo $url  ?>" alt="<?php echo $alt ?>">
    </a>
    ...
    <div class="my-4">
        ...
        <time class="text-primary-500 font-semibold my-1 text-sm"><?php echo get_the_date('', get_the_ID()) ?></time>
